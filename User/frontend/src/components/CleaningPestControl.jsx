...
import { Home, Sofa, Bath, Bug } from "lucide-react"
...
const CleaningPestControl = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Deep sanitization and cleaning of bathrooms",
      duration: "1-2 hours",
      rating: "4.9",
  ...
  return (
    <section className="py-16 relative bg-gradient-to-br from-sky-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Professional cleaning and pest control services for your home</p>
        </div>
